...
const Toast = () => {
  ...
  return (
    <section>
      <h1 className='text-2xl text-center py-10'>Toast</h1>
      <h3 className='py-2 text-xl'>Success</h3>
  ...
  Login successful!
      ...
      <h3 className='py-2 text-xl'>Warning</h3>
      <div className='w-80 md:w-full h-40 m-auto bg-veryDarkBlue rounded-md'>
        <div className='flex justify-center items-center h-full'>
  ...
  You are unauthorized to use this page
      ...
      <h3 className='py-2 text-xl'>Error</h3>
      <div className='w-80 md:w-full h-40 m-auto bg-veryDarkBlue rounded-md'>
        <div className='flex justify-center items-center h-full'>
